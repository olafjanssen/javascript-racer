 ...
 * name: 02-fullahead
 *
 * Full steam ahead agent: takes only its x position on the road as input and allows only left, neutral and right with full throttle.
